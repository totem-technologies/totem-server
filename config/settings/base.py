...
# Private messaging automation. All outbound automation is off until product enables it.
MESSAGING_KEEPER_FOLLOW_UP_ENABLED = env.bool("MESSAGING_KEEPER_FOLLOW_UP_ENABLED", default=False)
MESSAGING_KEEPER_FOLLOW_UP_NOTIFY_ENABLED = env.bool("MESSAGING_KEEPER_FOLLOW_UP_NOTIFY_ENABLED", default=False)
MESSAGING_SHARE_UPCOMING_SPACE_ENABLED = env.bool("MESSAGING_SHARE_UPCOMING_SPACE_ENABLED", default=False)
MESSAGING_DISCOVERY_NUDGE_ENABLED = env.bool("MESSAGING_DISCOVERY_NUDGE_ENABLED", default=False)
MESSAGING_KEEPER_FOLLOW_UP_DELAY_MINUTES = env.int("MESSAGING_KEEPER_FOLLOW_UP_DELAY_MINUTES", default=30)
MESSAGING_SHARE_UPCOMING_SPACE_DELAY_MINUTES = env.int("MESSAGING_SHARE_UPCOMING_SPACE_DELAY_MINUTES", default=30)
MESSAGING_DISCOVERY_NUDGE_DELAY_MINUTES = env.int("MESSAGING_DISCOVERY_NUDGE_DELAY_MINUTES", default=30)
MESSAGING_AUTOMATION_LOOKBACK_HOURS = env.int("MESSAGING_AUTOMATION_LOOKBACK_HOURS", default=24)
# Failed direct-message FCM sends are retried only while the recipient has not read the message.
MESSAGING_DIRECT_MESSAGE_RETRY_ENABLED = env.bool("MESSAGING_DIRECT_MESSAGE_RETRY_ENABLED", default=True)
MESSAGING_DIRECT_MESSAGE_RETRY_DELAY_MINUTES = env.int("MESSAGING_DIRECT_MESSAGE_RETRY_DELAY_MINUTES", default=15)
MESSAGING_DIRECT_MESSAGE_MAX_ATTEMPTS = env.int("MESSAGING_DIRECT_MESSAGE_MAX_ATTEMPTS", default=3)
MESSAGING_DIRECT_MESSAGE_RETRY_BATCH_SIZE = env.int("MESSAGING_DIRECT_MESSAGE_RETRY_BATCH_SIZE", default=100)

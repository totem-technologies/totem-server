...
from totem.messages.models import AutomationPrompt
from totem.messages.services import (
    can_users_message,
    session_allows_messaging,
)
from totem.messages.services import (
    retry_unread_message_notifications as retry_message_notifications,
)
from totem.notifications.services import send_notification_to_user
from totem.users.models import User

from .models import SESSION_END_TIME, Session
    ...
    try:
        with transaction.atomic():
            ...
            if locked_prompt.status != AutomationPrompt.Status.PENDING:
                return False
            # ponytail: This holds one row lock during FCM delivery; move to a transactional outbox if task volume grows.

...
!function(){window.atcb_action=function(a,o,n=!1){var[a,o,n=!1]=[a,o,n];if(l()){if((a=s(a)).hideBranding=!0,(a=null!=a.proKey&&""!=a.proKey?Ot(a.proKey):a).debug="true"===a.debug,tt(a)){a=J(a);let e=document.body;if(a.trigger="click",o?(null!=(e=o).id&&""!=o.id?a.identifier=o.id:(null!=a.identifier&&""!=a.identifier&&/^[\w\-_]+$/.test(a.identifier)?a.identifier="atcb-btn-"+a.identifier:a.identifier="atcb-btn-custom",o.id=a.identifier),"dropdown"!==a.listStyle&&"dropdown-static"!==a.listStyle&&"dropup-static"!==a.listStyle||(a.listStyle="modal")):(a.identifier="atcb-btn-custom",a.listStyle="modal"),et(a)){var i=1===a.options.length,r=document.getElementById("atcb-customTrigger-"+a.identifier+"-host");if(r&&(v(r.shadowRoot,!1),S[""+S.active]&&delete S[""+S.active],r.remove()),C("initialization",a.identifier,a.identifier),!a.blockInteraction){let t=null;(!i||"apple"!==a.options[0]&&"ical"!==a.options[0]||a.dates&&1<a.dates.length&&a.dates.organizer||Y())&&((t=document.createElement("div")).id="atcb-customTrigger-"+a.identifier+"-host",e==document.body?document.body.append(t):e.after(t),o&&(r=o.getBoundingClientRect(),t.style.position="relative",t.style.left=-r.width+"px",t.style.top=r.height+"px"),t.setAttribute("atcb-button-id",a.identifier),t.attachShadow({mode:"open",delegateFocus:!0}),(r=document.createElement("template")).innerHTML=Yt,t.shadowRoot.append(r.content.cloneNode(!0)),r=t.shadowRoot.querySelector(".atcb-initialized"),Bt(a),O(t.shadowRoot,a),t.shadowRoot.querySelector(".atcb-initialized").setAttribute("lang",a.language),Rt(t.shadowRoot,r,a.buttonStyle,!1,!1,a.customCss),Nt(t.shadowRoot,a)),i?(y(t.shadowRoot,a.options[0],a,"all",n),C("openSingletonLink",a.identifier,a.identifier)):x(t.shadowRoot,"open",a,o,n)}return Ut(a.proKey,a.debug),a.debug&&console.log('Add to Calendar Button "'+a.identifier+'" triggered'),a.identifier}}console.error(a.validationError)}}
/*!
 *  @preserve
 *
 * ++++++++++++++++++++++++++++++++++++++
